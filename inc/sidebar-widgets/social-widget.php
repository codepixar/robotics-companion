...
class robotics_social_widget extends WP_Widget {
...
'robotics_social_widget', 


// Widget name will appear in UI
esc_html__( '[ Robotics ] Social Widget', 'robotics-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'robotics-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'robotics-companion' );
}
...
} // Class robotics_social_widget ends here


// Register and load the widget
function robotics_social_load_widget() {
	register_widget( 'robotics_social_widget' );
}
add_action( 'widgets_init', 'robotics_social_load_widget' );