...
class robotics_author_widget extends WP_Widget {
...
'robotics_author_widget', 


// Widget name will appear in UI
esc_html__( '[ Robotics ] Author Widget', 'robotics-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'robotics-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'robotics-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'robotics-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'robotics-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'robotics-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'robotics-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'robotics-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'robotics-companion' ); ?>:</label>
	<div class="robotics-media-container">
		<div class="robotics-media-inner">
			...
			<span class="robotics-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'robotics-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="robotics-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'robotics-companion' ); ?>" class="button robotics-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'robotics-companion' ) : __( 'Select Image', 'robotics-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button robotics-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.robotics-media-container {
	width: 98%;
}

.robotics-media-inner {
...
jQuery(function($){
    ...
    wpshed_image_upload( '.robotics-media-upload' );
    ...
    wpshed_image_remove( '.robotics-media-remove' );
...
} // Class robotics_author_widget ends here


// Register and load the widget
function robotics_author_load_widget() {
	register_widget( 'robotics_author_widget' );
}
add_action( 'widgets_init', 'robotics_author_load_widget' );