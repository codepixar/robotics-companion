 ...
 * @since 1.0
 */
class Robotics_sh extends Widget_Base {
	...
	public function get_title() {
		return __( 'Section Heading', 'robotics-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'robotics-companion' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'robotics-companion' ),
