 ...
 * @since 1.0
 */
class Robotics_Gallery extends Widget_Base {

	public function get_name() {
		return 'robotics-gallery';
	}

	public function get_title() {
		return __( 'Gallery', 'robotics-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'gallery_content',
			[
				'label' => __( 'Gallery', 'robotics-companion' ),
			]
		);
		$this->add_control(
            'gallery_slider', [
                'label' => __( 'Create Gallery', 'robotics-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'col',
                        'label' => __( 'Column', 'robotics-companion' ),
