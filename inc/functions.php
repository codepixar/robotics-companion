...
function robotics_instagram_instance() {
...
// Blog Section
function robotics_blog_section( $postnumber ) {
...
// 
function robotics_section_heading( $title = '', $subtitle = '' ) {
    if( $title || $subtitle ):
    ?>
...
function robotics_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'robotics_contact7_form_content', 10, 2 );
